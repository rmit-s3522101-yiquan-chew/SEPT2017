...
public class MainpageManager {
	...
	public MainpageManager(Scene scene){
		this.scene = scene;
	}
	...
	public void showLoginScene() {
	    try {
	      ...
	      Logger.getLogger(MainpageManager.class.getName()).log(Level.SEVERE, null, ex);
	    }
	}
	...
	public void showRegisterScene(){
		try{
			...
			Logger.getLogger(MainpageManager.class.getName()).log(Level.SEVERE, null, e);
		}
	}	
}